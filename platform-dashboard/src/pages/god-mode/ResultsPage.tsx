  ...
  return (
    <section className="space-y-5 rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        <div>
          <p className="text-[11px] uppercase tracking-[0.3em] text-slate-500">Simulation results</p>
          <h2 className="mt-1 text-2xl font-bold text-slate-900">Risk, claims, and cash outflow</h2>
          <p className="mt-2 text-sm font-medium text-slate-600">Scope: {result.scopeLabel}</p>
        </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
        <div className="text-[11px] uppercase tracking-[0.25em] text-slate-500">Disruption reason</div>
        <div className="mt-2 text-sm font-semibold text-slate-900">{result.reason}</div>
        <div className="mt-2 text-sm text-slate-600">Action taken: {result.actionTaken}</div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
        ...
        <ul className="mt-3 space-y-2 text-sm text-slate-700">
          ...
          <li className="rounded-xl border border-slate-200 bg-white px-3 py-2">
            Affected zones: <span className="font-semibold text-slate-900">{result.affectedZoneCount}</span>
          </li>
        </ul>
      </div>

      <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
        <div className="text-[11px] uppercase tracking-[0.25em] text-slate-500">Backend endpoint monitor</div>
